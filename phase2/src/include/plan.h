...
public:
    ...
    virtual void print(int indent = 0, Optimizer* opt = nullptr, Executor* exec = nullptr) const = 0;
};
...
public:
    ...
    void print(int indent = 0, Optimizer* opt = nullptr, Executor* exec = nullptr) const override;
};
